...
// 	w.Write(p.Ui.HtmlPageTotp(r, FormState{}, []byte{}))
// }
//
// func (p PasswordHandler) Totp_POST(w http.ResponseWriter, r *http.Request) {
// 	if err := r.ParseForm(); err != nil {
// 		w.Write(p.Ui.HtmlPageTotp(r, FormState{Errors: ErrInternalServer}, []byte{}))
// 		return
// 	}
// 	otp := r.FormValue("otp")
//
...
// 	if err > 0 {
// 		w.Write(p.Ui.HtmlPageTotp(r, FormState{Username: png, Errors: err}, []byte{}))
// 		return
// 	}
//
